...
public class PartialContentController implements IController {
    ...
    public HttpResponse generateResponse(HttpRequest httpRequest) throws IOException  {
        ...
        return response(httpRequest, end, start, httpResponse, bytes, totalBytes);
    }

    private HttpResponse response(HttpRequest httpRequest, int end, int start, HttpResponse httpResponse, byte[] bytes, int totalBytes) throws IOException {
