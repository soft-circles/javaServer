...
import cob_spec.controllers.PartialContentController;
...
class PartialContentControllerTest {
    ...
    @Test
    void responseGeneratesA416StatusWhenRangeIsNotSatisfiable() throws IOException {
    ...
    @Test
    void bodyHasCorrectLength() {
        assertEquals(SIZE, httpResponse.getBody().length);
    }

    @Test
    void responseGeneratesA206Status() {
